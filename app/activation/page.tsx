  ...
  return (
    <div className="min-h-screen bg-gray-100" dir="rtl">
      <div className="container mx-auto px-4 py-12 md:py-20">
        ...
        {/* الجزء الثالث: خيارات التسليم مع QR */}
        <div className="max-w-5xl mx-auto mt-16 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">اختر الطريقة الأسهل لك لإرسال هذه المعلومات:</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            
            {/* واتساب مع QR */}
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center gap-4">
              <Image src="/images/qr-whatsapp.png" alt="WhatsApp QR Code" width={150} height={150} className="rounded-md" />
              <Link href="https://wa.me/967736066734?text=أهلاً،%20أنا%20جاهز%20لتزويدكم%20ببيانات%20متجر%20نماء%20لتفعيل%20المساعد%20الذكي." target="_blank" className="group flex items-center gap-2 text-lg font-semibold text-gray-800 hover:text-teal-600">
            ...
            {/* تيليجرام مع QR */}
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center gap-4">
              <Image src="/images/qr-telegram.png" alt="Telegram QR Code" width={150} height={150} className="rounded-md" />
              <Link href="https://t.me/tsahma" target="_blank" className="group flex items-center gap-2 text-lg font-semibold text-gray-800 hover:text-teal-600">
            ...
            {/* إيميل */}
            <Link href="mailto:info@aiuncode.com?subject=بيانات%20تفعيل%20المساعد%20الذكي%20لمتجر%20نماء&body=أهلاً،%0A%0Aمرفق%20لكم%20البيانات%20المطلوبة." target="_blank" className="group">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center justify-center gap-3 h-full">
            ...
            {/* مكالمة */}
            <Link href="tel:+9676066734" className="group">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center justify-center gap-3 h-full">
