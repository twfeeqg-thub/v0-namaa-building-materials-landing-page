...
import Image from "next/image" // استخدام مكون Image من Next.js للأداء
  ...
  return (
    <div key="1" className="flex flex-col min-h-[100dvh]" dir="rtl">
      ...
      <main className="flex-1">
        {/* تم تعديل هذا القسم بالكامل ليحتوي على معرض الصور الثابت */}
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-5 gap-3">
                  <Image
                    alt="صورة من داخل المحل 1"
                    className="aspect-square w-full rounded-lg object-cover"
                    height="100"
                    src="/images/namaa-2.jpg"
                    width="100"
                  />
                  <Image
                    alt="صورة من داخل المحل 2"
                    className="aspect-square w-full rounded-lg object-cover"
                    height="100"
                    src="/images/namaa-3.jpg"
                    width="100"
                  />
                  <Image
                    alt="صورة من داخل المحل 3"
                    className="aspect-square w-full rounded-lg object-cover"
                    height="100"
                    src="/images/namaa-4.jpg"
                    width="100"
                  />
                  <Image
                    alt="صورة من داخل المحل 4"
                    className="aspect-square w-full rounded-lg object-cover"
                    height="100"
                    src="/images/namaa-5.jpg"
                    width="100"
                  />
                  <Image
                    alt="صورة من داخل المحل 5"
                    className="aspect-square w-full rounded-lg object-cover"
                    height="100"
                    src="/images/namaa-6.jpg"
                    width="100"
                  />
                </div>
              </div>
              {/* === نهاية معرض الصور الجديد === */}
            </div>
          </div>
        </section>
