// هذا السطر يستدعي مكتبة السلايدر التي طلبنا تثبيتها
...
export default function Component() {
  // هذا السطر يقوم بتفعيل السلايدر وجعل الصور تدور بشكل لا نهائي
  const [emblaRef] = useEmblaCarousel({ loop: true }); 
  
  // هذه هي روابط الصور التي استخرجتها لك
  const imageUrls = [
...
// Icons Components (No changes needed here, but included for completeness)
...
// ... (The rest of the icon components are the same, I will omit them for brevity but they are in your original file)
// ... BrickIcon, BuildingIcon, ClockIcon, FileTextIcon, HammerIcon, MessageCircleIcon, PaintbrushIcon, ShieldIcon, ShoppingCartIcon, WrenchIcon

// Paste all the icon components from your original file here.
// For example:
function BrickIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
    return (
      <svg
